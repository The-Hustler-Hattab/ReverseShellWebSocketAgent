...
public interface Constants {
    ...
    public static final String LOCAL_SERVER_WEBSOCKET_URI = "wss://127.0.0.1:8070/reverseShellClients" ;

    public static final String PROD_SERVER_WEBSOCKET_URI = "wss://<?>/reverseShellClients" ;



    public static final String LOCAL_SERVER_HTTP_URI = "https://127.0.0.1:8070" ;
